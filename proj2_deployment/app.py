...
model = pickle.load(open('credit.pickle', 'rb'))
...
features = [int(limitbal),edu,mar,int(age),stats,int(b_month1),int(b_month2),int(b_month3),int(b_month4),int(b_month5),int(b_month6),int(p_month1),int(p_month2),int(p_month3),int(p_month4),int(p_month5),int(p_month6)]
